...
const About = () => {
  ...
  return (
    <section
      id="about"
      className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-slate-50/50 via-white to-emerald-50/30 relative overflow-hidden"
    >
          ...
          <div className="lg:order-2">
              ...
              <div className="w-full aspect-square rounded-3xl overflow-hidden shadow-2xl group-hover:shadow-3xl transition-all duration-700 bg-gradient-to-br from-gray-200 to-gray-300 relative">
                ...
                <img
                  ...
                  className={`absolute inset-0 w-full h-full object-cover transition-all duration-700 ${
                    imageHover ? "opacity-0 scale-110" : "opacity-100 scale-100"
                  }`}
                />
                ...
                <img
                  ...
                  className={`absolute inset-0 w-full h-full object-cover transition-all duration-700 ${
                    imageHover ? "opacity-100 scale-100" : "opacity-0 scale-90"
                  }`}
                />

                {/* Light Name Overlay */}
                <div
                  className={`absolute bottom-0 left-0 right-0 opacity-0 group-hover:opacity-100 transition-all duration-700 p-6`}
                >
            ...
            <div className="grid grid-cols-3 gap-4 mt-12 text-center">
              {[
                ...
                <div
                  key={idx}
                  className="group p-4 bg-white/70 backdrop-blur-xl rounded-2xl shadow-lg hover:shadow-emerald-300/50 hover:scale-105 transition-all duration-400 border border-emerald-100/50"
                >
